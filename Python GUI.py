...
my_img=ImageTk.PhotoImage(Image.open("C:/Users/Arpita/Pictures/Coding.png"))
my_label=Label(image=my_img).grid(row=0,column=0)

mylabel1=Label(screen,text="Choose the program you want to run", font=("Corbel",28,"bold"),bg="#FFB6C1")
mylabel1.grid(row=0,column=1)
mylabel2=Label(screen,text="Program 1: Largest Prime Factor of a given integer", font=("Corbel",20),bg="#FFB6C1")
mylabel2.grid(row=1,column=1)
mylabel3=Label(screen,text="Program 2: Set & Tuple Operations", font=("Corbel",20),bg="#FFB6C1")
mylabel3.grid(row=2,column=1)
screen.config(background='#FFB6C1')
...
def program1():
    new=Toplevel()
    new.title("Program 1")
    new.config(background='#DDA0DD')
    new.geometry("2000x1000")
    label1=Label(new,text="                          ",bg='#DDA0DD').grid(row=0,column=0)
    label3=Label(new,text="                          ",bg='#DDA0DD').grid(row=0,column=1)
    mylabel4=Label(new,text="......Largest Prime Factor of a given integer......", font=("Corbel",20),bg='#DDA0DD')
    mylabel4.grid(row=0,column=3)
    label2=Label(new,text="  ",bg='#DDA0DD').grid(row=1,column=1)
    e1=Entry(new)
